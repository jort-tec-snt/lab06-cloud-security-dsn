...
const policies = [
  ...
  ["PAIS_PERMITIDO", "Restricción geográfica", "El país del usuario debe coincidir con el país asignado al documento.", { atributoUsuario: "pais", operador: "igual", atributoRecurso: "pais" }],
  ...
  ["PROPIETARIO_DOCUMENTO", "Control del propietario", "Solo el propietario puede modificar o eliminar un documento, salvo roles privilegiados.", { acciones: ["MODIFICAR_DOCUMENTO", "ELIMINAR_DOCUMENTO"], atributoUsuario: "id", atributoRecurso: "propietarioId", excepcionesRol: ["ADMINISTRADOR"] }],
