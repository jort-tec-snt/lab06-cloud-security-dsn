...
- Las políticas ABAC son un catálogo independiente con código, explicación, estado y configuración JSON. El motor centralizado evalúa los códigos activos y el CRUD de documentos lo invoca en cada operación.
